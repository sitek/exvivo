...
fnirt --ref=/om/user/ksitek/exvivo/data/Reg_S64550_nii_b0-slice_fslreorient2std.nii.gz \
      ...
      --warpres=4,4,4 \
      --cout=om/user/ksitek/exvivo/maastricht/maas2exvivo_warp4_coef
      --iout=/om/user/ksitek/exvivo/maastricht/maas2exvivo_fnirt_warp4.nii.gz \
      --fout=/om/user/ksitek/exvivo/maastricht/maas2exvivo_fnirt_warp4_warpfield
