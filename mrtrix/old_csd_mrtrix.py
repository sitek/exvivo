...
# Investigate corticospinal tract (CST) in data from the connectome scanner at MGH Martinos Center. This is a replication of Farquharson et al. (2013 - J Neurosurg), who worked entirely in MRtrix (except for manual target/seed masks).
