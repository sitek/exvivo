...
/om/user/ksitek/scripts/dtk/hardi_mat "/om/user/ksitek/exvivo/data/camino_120_RAS_flipped-z.bvecs" \
    "/om/user/ksitek/scripts/dtk/matrices/exvivo_121_flipped-z_mat.dat" \
...
/om/user/ksitek/scripts/dtk/odf_recon "/om/user/ksitek/exvivo/data/Reg_S64550_nii4d.nii" \
    ...
    -mat "/om/user/ksitek/scripts/dtk/matrices/exvivo_121_flipped-z_mat.dat" \
    -p 3 -sn 1 -ot nii 
